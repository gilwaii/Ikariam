...
import ui.LogBattleFieldFightingUI;
import ui.IsLandUI;
 ...
 * @author GBlue
 */
public class LogBattleFieldFighting {

    private BattleField attackBattleField, defenceBattleField;
    private boolean war;
    private int houseID;

    public LogBattleFieldFighting(int houseID) {
    ...
    public void startAttack() {
        ...
        if (IsLandUI.bffUI == null) {
            IsLandUI.lbffUI = new LogBattleFieldFightingUI(this);
        } else {
            IsLandUI.lbffUI.resetLogBattleFieldFightingUI(this);
        }
        ...
        //
                ...
                if (attackBattleField.isAllDead()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Enemy "+IsLandUI.house[houseID].getName()+" won2");

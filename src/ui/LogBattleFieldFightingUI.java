...
import model.LogBattleFieldFighting;

/**
 *
 * @author GBlue
 */
public class LogBattleFieldFightingUI extends JDialog{
    ...
    LogBattleFieldFighting battleFieldFighting; 
    
    public LogBattleFieldFightingUI(LogBattleFieldFighting battleFieldFighting) {
...
//         for(Army.Unit unit: Army.Unit.values()){
    ...
    public LogBattleFieldFighting getBattleFieldFighting() {
        return battleFieldFighting;
    }

    public void setLogBattleFieldFighting(LogBattleFieldFighting battleFieldFighting) {
        this.battleFieldFighting = battleFieldFighting;
    }
    
    public void resetLogBattleFieldFightingUI(LogBattleFieldFighting battleFieldFighting){
        pnMain.removeAll();
       this.battleFieldFighting = battleFieldFighting;
       pnAttack = new PnBattleFieldFighting(battleFieldFighting.getAttackBattleField());
       pnDefence = new PnBattleFieldFighting(battleFieldFighting.getDefenceBattleField());

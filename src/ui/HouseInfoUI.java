...
public class HouseInfoUI extends JDialog {
    ...
    public void addControls() {
        ...
        lblImg = new JLabel(new ImageIcon(getClass().getResource("/Image/House/allyHouseLv8.PNG")));
        ...
        this.addComponentListener(new ComponentAdapter() {
            public void componentShown(ComponentEvent evt) {
                ...
                if (IsLandUI.currentHouse.getTypeOfHouse() == 2) {
                    ...
                    lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv8.PNG")));
                } else if (IsLandUI.currentHouse.getTypeOfHouse() == 0) {
                    btnPillage.setEnabled(false);
                    btnPillage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Pillage_Disabled.PNG")));
                    lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv8.PNG")));
                }
                else if (IsLandUI.currentHouse.getTypeOfHouse() == 1) {
                    btnPillage.setEnabled(false);
                    btnPillage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Pillage_Disabled.PNG")));
                    lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv8.PNG")));
                }
                else if (IsLandUI.currentHouse.getTypeOfHouse() == 1) {
                    btnPillage.setEnabled(false);
                    btnPillage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Pillage_Disabled.PNG")));
                    lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Flag_red.PNG")));
                }
...
//            IsLandUI.currentHouse.getBattleField().resetAll(IsLandUI.currentHouse.getLevelOfHouse());
        ...
        if (type.equals("My House")) {
            ...
            IsLandUI.currentHouse.setTypeOfHouse(3);
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Flag_red.PNG")));
        }
    ...
    private void setIconHouse() {
    	...
    	// Me
        if (IsLandUI.currentHouse.getLevelOfHouse() == 1 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv1.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 2 && IsLandUI.currentHouse.getLevelOfHouse() <= 3 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv2.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 4 && IsLandUI.currentHouse.getLevelOfHouse() <= 6 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv3.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 7 && IsLandUI.currentHouse.getLevelOfHouse() <= 9 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv4.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 10 && IsLandUI.currentHouse.getLevelOfHouse() <= 12 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv5.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 13 && IsLandUI.currentHouse.getLevelOfHouse() <= 15 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv6.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() == 16 || IsLandUI.currentHouse.getLevelOfHouse() == 17 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv7.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 18 && IsLandUI.currentHouse.getTypeOfHouse() == 0) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/enemyHouseLv8.PNG")));
        }
        
        //Enemy
        if (IsLandUI.currentHouse.getLevelOfHouse() == 1 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv1.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 2 && IsLandUI.currentHouse.getLevelOfHouse() <= 3 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv2.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 4 && IsLandUI.currentHouse.getLevelOfHouse() <= 6 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv3.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 7 && IsLandUI.currentHouse.getLevelOfHouse() <= 9 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv4.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 10 && IsLandUI.currentHouse.getLevelOfHouse() <= 12 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv5.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 13 && IsLandUI.currentHouse.getLevelOfHouse() <= 15 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv6.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() == 16 || IsLandUI.currentHouse.getLevelOfHouse() == 17 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv7.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 18 && IsLandUI.currentHouse.getTypeOfHouse() == 2) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/myHouseLv8.PNG")));
        }
        
      //Ally
        if (IsLandUI.currentHouse.getLevelOfHouse() == 1 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv1.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 2 && IsLandUI.currentHouse.getLevelOfHouse() <= 3 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv2.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 4 && IsLandUI.currentHouse.getLevelOfHouse() <= 6 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv3.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 7 && IsLandUI.currentHouse.getLevelOfHouse() <= 9 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv4.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 10 && IsLandUI.currentHouse.getLevelOfHouse() <= 12 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv5.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 13 && IsLandUI.currentHouse.getLevelOfHouse() <= 15 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv6.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() == 16 || IsLandUI.currentHouse.getLevelOfHouse() == 17 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv7.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 18 && IsLandUI.currentHouse.getTypeOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/allyHouseLv8.PNG")));
        }
